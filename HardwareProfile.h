...
#define HARDWARE_PROFILE_PICDEM_FSUSB_K50_H
    ...
    /** POT ************************************************************/
    #define mInitPOT()          {TRISAbits.TRISA1=1;ANSELAbits.ANSA1=1;ADCON1=0;ADCON2bits.ACQT = 0b111; ADCON2bits.ADCS = 0b110; ADCON2bits.ADFM = 0; ADCON0=0x01;ADCON0bits.CHS = 0b00001;}
